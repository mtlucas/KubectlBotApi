...
using KubectlBotApi.Api.WebHost;
...
try
{
    ...
    builder.Services.AddSwaggerGen(options =>
    {
        ...
        {
            Version = "v1",
            Title = "KubectlBot Api",
            Description = "An ASP.NET Core Web API for issuing KUBECTL commands to container running on Kubernetes",
    ...
    app.Run();
    Log.Debug("KubectlBotApi application started.");
}
catch (Exception ex)
{
