...
class Build : NukeBuild
{
    ...
    [Parameter("Project Description")] readonly string ProjectDescription = "KubectlBotApi Nuget Package built on " + DateTime.UtcNow.ToString("MM-dd-yyyy"); //default
    ...
    [Parameter("Project VCS Url")] readonly string ProjectUrl = "https://dev-gitlab.dev.rph.int/rollout/kubectlbotapi"; //default
